...
match CONFIG["DATASET"]:
    case "QM9":
        dataset = QM9Dataset(path="/home/bori9691/2025/Edge_Moire/data/qm9/qm9_data_eV_edges.pkl")
        criterion = nn.L1Loss()
...
aliquot = Aliquot(
    ...
    criterion=criterion,
    scheduler=scheduler,
)(wandb_project="moire_edge_eV", wandb_config=CONFIG, num_epochs=10000, patience=20)
